...
import { 
  ...
  serverTimestamp, onSnapshot, query, orderBy, collectionGroup, where 
...
export async function postReview(movieId, userId, userName, rating, text, mediaType = 'movie') {
  ...
  await addDoc(reviewsRef, {
    ...
    mediaType, // Store mediaType (movie/tv)
...
export function useUserReviews(userId) {
  ...
  useEffect(() => {
    ...
    // Using collectionGroup to find all 'reviews' subcollections across all movies
    const q = query(
